...
void _default_fragment_shader(RenderPipeline* pipeline, void** params) {
	kmemcpy<64>(pipeline->renderTexture, pipeline->fragTexture, (pipeline->display_w * pipeline->display_h) >> 4);
	...
	//}
	kbzero<64>(pipeline->fragTexture, (pipeline->display_w * pipeline->display_h) >> 4);
	//for (uint32_t index = 0; index < pipeline->display_w * pipeline->display_h; index++) {
