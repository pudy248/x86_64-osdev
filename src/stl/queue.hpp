...
public:
	constexpr T& operator*() { return ptr[offset]; }
	constexpr const T& operator*() const { return ptr[offset]; }
	...
	constexpr bool operator==(const queue_iterator& other) const {
		return ptr == other.ptr && offset == other.offset && length == other.length;
	}
};
...
public:
	...
	constexpr queue_iterator<T> begin() { return {vector<T, A>::m_arr, vector<T, A>::m_size, head}; }
	constexpr const queue_iterator<T> begin() const { return {vector<T, A>::m_arr, vector<T, A>::m_size, head}; }
	constexpr queue_iterator<T> end() { return {vector<T, A>::m_arr, vector<T, A>::m_size, tail}; }
	constexpr const queue_iterator<T> end() const { return {vector<T, A>::m_arr, vector<T, A>::m_size, tail}; }
