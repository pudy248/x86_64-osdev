...
constexpr Init transform_reduce(R&& range, const R2& range2, Init init = {}, BinaryOp transform = {},
								BinaryOp2 reduce = {}) {
...
constexpr Init reduce_transform(InR&& range, const InR2& range2, OutR&& out, Init init = {}, BinaryOp reduce = {},
								BinaryOp2 transform = {}) {
	return algo::reduce_transform(ranges::begin(out), ranges::end(out), ranges::begin(range), ranges::end(range),
...
template <ranges::range OutR, ranges::range InR, ranges::range InR2, typename BinaryPred = algo::equal_to>
constexpr ranges::iterator_t<OutR> copy_until_block(OutR&& out, InR&& range, const InR2& range2,
...
template <ranges::range OutR, ranges::range InR, ranges::range InR2, typename BinaryPred = algo::equal_to>
constexpr ranges::iterator_t<OutR> copy_through_block(OutR&& out, InR&& range, const InR2& range2,
													  BinaryPred predicate = {}) {
