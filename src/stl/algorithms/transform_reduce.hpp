...
constexpr Init transform_reduce(
	I begin, S end, I2 begin2, S2 end2, Init init = {}, BinaryOp transform = {}, BinaryOp2 reduce = {}) {
...
constexpr Init transform_reduce(
	I begin, S end, I2 __restrict begin2, Init init = {}, BinaryOp transform = {}, BinaryOp2 reduce = {}) {
...
constexpr Init reduce_transform(
	OutI out, OutS out_end, InI begin, InS end, Init init = {}, BinaryOp reduce = {}, UnaryOp transform = {}) {
	for (; begin != end && out != out_end; ++begin, ++out) {
...
[[deprecated("Unbounded output iterator")]]
constexpr Init reduce_transform(
	OutI out, InI begin, InS end, Init init = {}, BinaryOp reduce = {}, UnaryOp transform = {}) {
