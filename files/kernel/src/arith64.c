...
arith64_u64 __divmoddi4(arith64_u64 a, arith64_u64 b, arith64_u64 *c)
{
    ...
    char bits = (char)(__clzdi2(b) - __clzdi2(a) + 1);  // number of bits to iterate (a and b are non-zero)
    ...
    while (bits-- > 0)                          // for each bit
    {
        ...
        wrap = (arith64_u64)((arith64_s64)(b - rem - 1) >> 63);  // wrap = (b > rem) ? 0 : 0xffffffffffffffff (via sign extension)
...
arith64_s64 __divdi3(arith64_s64 a, arith64_s64 b)
{
    arith64_u64 q = __divmoddi4((arith64_u64)arith64_abs(a), (arith64_u64)arith64_abs(b), (void *)0);
    return arith64_neg((arith64_s64)q, a^b); // negate q if a and b signs are different
}
...
{
    arith64_u64 r;
    __divmoddi4((arith64_u64)arith64_abs(a), (arith64_u64)arith64_abs(b), &r);
    return (arith64_s64)arith64_neg(r, a); // negate remainder if numerator is negative
}
