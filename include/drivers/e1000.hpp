...
namespace E1000_RCTL { enum E1000_RCTL : uint32_t {
    EN      =1<<1,
    SBP     =1<<2,
    UPE     =1<<3,
    MPE     =1<<4,
...
namespace E1000_TCMD { enum E1000_TCMD : uint8_t {
    EOP     =1<<0,
    IFCS    =1<<1,
    IC      =1<<2,
    RS      =1<<3,
...
namespace E1000_TCTL { enum E1000_TCTL : uint32_t {
    EN      =1<<1,
    CTSHIFT =4,
    CTCSHIFT=12,
    PSP     =1<<3,
...
namespace E1000_TSTA { enum E1000_TSTA : uint8_t {
    DD      =1<<0,
    EC      =1<<1,
    LC      =1<<2,
    TU      =1<<3,
